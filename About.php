...
<main id="content" class="main-content-wrapper page-about">
				...
				<div class="col-12 col-sm-12 col-md-7 col-lg-6">
					<div class="content-wrapper">
						<div class="section-title left-aligned with-border">
							<h2>Welcome To Ororus Store!</h2>
						</div>
						<p class="lead">Ororus Shop is a premium HTML template designed and develoved from the ground up with the sole purpose of helping you create an astonishing, the beautiful and user friendly website that will boost your product’s sales.</p>
	...
	<section class="team-section pt-full team-bottom-padding bgc-offset">
		<div class="container">
			<div class="row">
				<div class="col-12 col-sm-12 col-md-12">
					<div class="section-title">
						<h2>Ororus Team Members</h2>
					</div>
				</div>
			</div> <!-- end of row -->
					...
					<div class="team-wrapper">
						<div class="team-media">
							...
							<div class="team-socials">
								...
								<div class="chain-animation">
									<a class="bg-twitter" title="Wishlist" href="#">
